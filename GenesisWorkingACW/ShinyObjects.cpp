...
ShinyObjs::ShinyObjs(const std::shared_ptr<DX::DeviceResources>& deviceResources) :m_deviceResources(deviceResources), m_position(5.f, 0.f, 5.5f), m_rotation(0.0f, 0.0f, 0.0f), m_scale(1.f, 1.f, 1.f)
{
	CreateDeviceDependentResources();
}


void ShinyObjs::Render()
{
...
void ShinyObjs::SetViewProjectionMatrixConstantBuffer(DirectX::XMMATRIX& view, DirectX::XMMATRIX& projection)
{
...
void ShinyObjs::ReleaseDeviceDependentResources()
{
...
void ShinyObjs::SetCameraPositionConstantBuffer(DirectX::XMFLOAT3& cameraPosition)
{
	m_camBufferData.position = cameraPosition;
	m_camBufferData.padding = 1;
}

void ShinyObjs::Update(DX::StepTimer const& timer)
{
