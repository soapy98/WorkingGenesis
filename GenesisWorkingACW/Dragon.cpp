...
void Dragon::CreateDeviceDependentResources()
{
	auto loadVSTask = DX::ReadDataAsync(L"DragonVS.cso");
...
void Dragon::SetViewProjectionMatrixConstantBuffer(DirectX::XMMATRIX& view, DirectX::XMMATRIX& projection)
{
...
void Dragon::SetCameraPositionConstantBuffer(DirectX::XMFLOAT3& cameraPosition)
{
...
void Dragon::Update(DX::StepTimer const& timer)
{
...
void Dragon::ReleaseDeviceDependentResources()
{
